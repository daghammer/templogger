...
url="http://www.kolaasbakkane.no/datalogger/datalogger.php"
...
for name in sensor_names:
	...
	payload = { 'sensor' : name.strip(), 'time':  datetime.now().strftime("%Y-%m-%d %H:%M:%S"), 'hostname': hostname, 'temp' : str(temp) }
